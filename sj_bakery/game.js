...
import {createPastryTiles,SNACK_MENUS} from './pastries.js?v=shared-kids-7';
...
function showHelp(){
 ...
 showModal('<div class="small-stamp">제과점의 작은 안내서</div><h2 id="modal-title">이렇게 포장해요</h2><ol class="help-list"><li>가로 · 전체화면에서 진행해요. 새 게임마다 <b>단계 난이도는 같고 과자 모양은 달라져요.</b></li><li>아빠는 버터 과자, 엄마는 캐러멜·초콜릿을 포장해요. <b>수안과 정안</b>은 홀수 단계에 수안의 젤리·마시멜로 간식, 짝수 단계에 정안의 마법 간식을 포장해요.</li><li>스테이지마다 <b>5초 준비 시간</b>이 있어요. 첫 과자가 다가오는 동안 정답을 살펴보세요. 도착하면 60초가 시작돼요.</li><li>초록 타일 위 <b>작업 구역</b>에 들어온 과자를 조작해요.</li><li><b>← →</b>는 90도 회전, <b>↑</b>는 위아래 뒤집기, <b>↓</b>는 좌우 뒤집기예요.</li><li>휴대폰을 <b>가로로</b> 돌리면 왼쪽 위는 위아래 뒤집기, 왼쪽 아래는 좌우 뒤집기예요. 오른쪽 위는 반시계, 아래는 시계 회전 버튼이에요.</li><li><b>상자 속 정답</b>과 모양·장식을 맞추면 자동으로 포장돼요. 제한 시간은 <b>2초</b>!</li><li>초록 O는 성공, 빨간 X는 실패. 1분 동안 <b>30개 중 25개</b> 이상 성공하면 다음 단계로 가요.</li><li>스테이지 실패 시 하트 하나를 잃고 재도전해요. <b>하트 3개, 총 10단계</b>에 도전해 보세요.</li></ol><button class="primary-button" id="close-help">알겠어요!</button>');
